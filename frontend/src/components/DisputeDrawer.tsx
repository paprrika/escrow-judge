        ...
        <>
          ...
          >
            ...
            <div className={s.section}>
              ...
              <p className={s.note}>
                Bond: {weiToGen(dispute.bond)} GEN · {dispute.bond_refunded ? "refunded" : "locked"}
              </p>
            </div>
            ...
            >
              ...
              {dispute.finalized_at_seq > 0 ? (
                <>
                  ...
                  <p className={s.note}>
                    Paid seller {weiToGen(dispute.settled_seller)} GEN · refunded buyer{" "}
                    {weiToGen(dispute.settled_buyer)} GEN
                  </p>
                </>
              ) : (
