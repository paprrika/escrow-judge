              ...
              <div className={s.bench}>
                <div className={s.benchCol}>
                  ...
                  <div className={s.facts}>
                    ...
                    <div className="kv"><span>paid to seller</span><b className="mono">{weiToGen(sel.released)} GEN</b></div>
                    <div className="kv"><span>refunded to buyer</span><b className="mono">{weiToGen(sel.refunded)} GEN</b></div>
                    <div className="kv"><span>still locked</span><b className="mono">{weiToGen(sel.locked)} GEN</b></div>
